...
pub fn get_achievements() -> Vec<Achievement> {
    vec![
        Achievement { id: "first_step".into(), name: "First Steps".into(), description: "Enter the Prometheus Facility.".into(), icon: "\u{1f6b6}".into(), unlocked: false, unlocked_at: None, hidden: false },
        Achievement { id: "explorer".into(), name: "Facility Explorer".into(), description: "Visit 5 different rooms.".into(), icon: "\u{1f5fa}".into(), unlocked: false, unlocked_at: None, hidden: false },
        Achievement { id: "cartographer".into(), name: "Master Cartographer".into(), description: "Visit every room in the facility.".into(), icon: "\u{1f5fa}".into(), unlocked: false, unlocked_at: None, hidden: true },
        Achievement { id: "collector".into(), name: "Hoarder".into(), description: "Collect 5 items.".into(), icon: "\u{1f392}".into(), unlocked: false, unlocked_at: None, hidden: false },
        Achievement { id: "bookworm".into(), name: "Bookworm".into(), description: "Find and read all documents.".into(), icon: "\u{1f4da}".into(), unlocked: false, unlocked_at: None, hidden: true },
        Achievement { id: "puzzle_master".into(), name: "Puzzle Master".into(), description: "Solve 3 puzzles.".into(), icon: "\u{1f9e0}".into(), unlocked: false, unlocked_at: None, hidden: false },
        Achievement { id: "codebreaker".into(), name: "Codebreaker".into(), description: "Crack the Director's office code.".into(), icon: "\u{1f510}".into(), unlocked: false, unlocked_at: None, hidden: false },
        Achievement { id: "chemist".into(), name: "Amateur Chemist".into(), description: "Create the Prometheus Stabilizer.".into(), icon: "\u{1f9ea}".into(), unlocked: false, unlocked_at: None, hidden: false },
        Achievement { id: "engineer".into(), name: "Chief Engineer".into(), description: "Repair the facility's generator.".into(), icon: "\u{2699}".into(), unlocked: false, unlocked_at: None, hidden: false },
        Achievement { id: "hacker".into(), name: "Elite Hacker".into(), description: "Decrypt the classified files.".into(), icon: "\u{1f4bb}".into(), unlocked: false, unlocked_at: None, hidden: false },
        Achievement { id: "savior".into(), name: "Facility Savior".into(), description: "Stabilize the Prometheus Core.".into(), icon: "\u{1f48e}".into(), unlocked: false, unlocked_at: None, hidden: true },
        Achievement { id: "escape_artist".into(), name: "Escape Artist".into(), description: "Reach the surface exit.".into(), icon: "\u{1f30d}".into(), unlocked: false, unlocked_at: None, hidden: true },
        Achievement { id: "hero".into(), name: "Hero".into(), description: "Complete the game.".into(), icon: "\u{2b50}".into(), unlocked: false, unlocked_at: None, hidden: true },
    ]
}
